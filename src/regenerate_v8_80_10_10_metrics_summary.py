#!/usr/bin/env python3
"""Regenerate metrics_summary.png for YOLOv8 80_10_10 split
based on the current metrics.json values.

This script reads the already-updated evaluation_metrics and
confusion_matrix from metrics.json and ONLY redraws the
metrics_summary.png heatmap for this split.
"""
...
def main() -> None:
    ...
    ax.set_ylim(0.0, 1.0)
    ax.set_ylabel("Score")
    ax.set_title("YOLOv8 Metrics Summary (80/10/10)")
