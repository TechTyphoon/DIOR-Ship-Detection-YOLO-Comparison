#!/usr/bin/env python3
"""Generate confusion_matrix.png for YOLOv8 70_15_15 split
...
METRICS_PATH = REPO_ROOT / "runs" / "detect" / "v8_metrics" / "splits" / "70_15_15" / "metrics" / "metrics.json"
OUTPUT_PATH = REPO_ROOT / "runs" / "detect" / "v8_metrics" / "splits" / "70_15_15" / "metrics" / "confusion_matrix.png"
...
def main() -> None:
    ...
    ax.set_title("Confusion Matrix - YOLOv8 70/15/15", fontsize=12, weight="bold", pad=20)
