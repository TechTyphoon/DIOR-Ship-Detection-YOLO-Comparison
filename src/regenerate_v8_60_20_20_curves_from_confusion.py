#!/usr/bin/env python3
"""Regenerate PR and ROC curves for YOLOv8 60_20_20 using the
...
def build_probabilities_from_confusion(tp: int, fn: int, fp: int, tn: int, *, seed: int = 60):
...
def regenerate_curves() -> None:
    ...
    plt.title("Precision-Recall Curve - YOLOv8 60/20/20", fontsize=12, weight="bold")
    ...
    plt.title("ROC Curve - YOLOv8 60/20/20", fontsize=12, weight="bold")
    plt.grid(True, alpha=0.3)
